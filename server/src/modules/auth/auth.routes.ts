...
router.patch('/me/profile', requireAuth, authController.updateProfileController);
router.post('/change-password', requireAuth, authRateLimit, authController.changePasswordController);
